...
export function Step1PIN({
  ...
  const handleIdSearch = async () => {
    ...
    try {
      const response = await fetch(
        `/api/manufacturer/brs?id=${encodeURIComponent(
          idNumber
  ...
  const handlePINChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (newPin.length === 11) {
      ...
      try {
        const response = await fetch(
          `/api/manufacturer/kra?pin=${encodeURIComponent(newPin)}`,
          {
            method: "GET",
          }
        );
      ...
      <div className="border-b border-gray-200">
        <nav className="-mb-px flex gap-2 overflow-x-auto">
          <button
            ...
            className={cn(
              "py-2 px-3 md:px-4 text-xs md:text-sm font-medium whitespace-nowrap rounded-t-lg",
              activeTab === "id"
      ...
      {activeTab === "id" ? (
        <div className="space-y-4">
          ...
          {idSearchStatus !== "found" && (
            <div className="flex justify-end">
              <Button
                ...
                disabled={
                  !idNumber || !firstName || idSearchStatus === "searching"
                }
                className="w-full md:w-auto px-4 bg-primary hover:bg-primary/90 text-sm"
              >
          ...
          {idSearchStatus === "found" && taxpayerData && (
            <div className="p-3 md:p-4 bg-green-50 border border-green-200 rounded-md space-y-3">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
                ...
                <Badge
                  variant="default"
                  className="text-xs bg-primary/20 text-primary w-fit"
                >
                  PIN: {taxpayerData.pin}
                </Badge>
              </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <div className="flex flex-col md:flex-row justify-between gap-1 md:items-center">
                ...
                <div className="flex-shrink-0">
                  {pinValidationStatus === "checking" && (
                    <Badge
                      variant="secondary"
                      className="text-xs bg-purple-100 text-purple-800 animate-bounce"
                    >
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="space-y-0.5 p-2 bg-gray-50 rounded-md">
                  ...
                  <p className="text-sm text-black font-medium">
                    {manufacturerDetails.businessDetails?.name}
                  </p>
                </div>
                <div className="space-y-0.5 p-2 bg-gray-50 rounded-md">
                  ...
                  <p className="text-sm text-black font-medium">
                    {manufacturerDetails.businessDetails?.registrationNumber}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="p-2 bg-gray-50 rounded-md">
                ...
                <p className="text-sm text-black font-medium">
                  {manufacturerDetails.physicalAddress.descriptive}
                </p>
              </div>
            </div>
          </div>
          ...
          {filingStatus.completed && (
            <div className="mt-4 p-2 border rounded-lg">
              ...
              <p className="text-xs text-muted-foreground">
                Your nil returns have been successfully filed. Receipt number:
                NR{Math.random().toString().slice(2, 10)}
              </p>
